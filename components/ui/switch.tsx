...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "group-hover:scale-[92%] block h-[16px] w-[16px] rounded-full bg-white shadow-lg ring-0 transition-transform transform-gpu hover:scale-90 data-[state=checked]:translate-x-5 data-[state=unchecked]:translate-x-[2.5px] data-[state=checked]:dark:bg-[#20B8CD] dark:bg-textOffDark"
      )}
    />
  </SwitchPrimitives.Root>
));
