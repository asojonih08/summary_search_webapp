...
import SearchVideosSkeleton from "./SearchVideosSkeleton";
      ...
      {videoSearchResults && (
        <div className="grid lg:grid-cols-2 grid-cols-1 gap-2">
          {videoSearchResults.length > 0 &&
            videoSearchResults.slice(0, 4).map((videoSearchResult, index) => (
              <div
                onClick={() => {
              ...
              >
                ...
                <div className="z-50 pr-2 group-hover:opacity-100 opacity-0 absolute top-1.5 left-2 text-white drop-shadow-sm text-xs font-medium transition-opacity duration-100 line-clamp-3">
